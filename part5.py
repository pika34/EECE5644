...
def plot_results(all_results, best_P):
    ...
    colors = {100: 'red', 500: 'blue', 1000: 'green', 10000: 'purple'}
    markers = {100: 'o', 500: 's', 1000: '^', 10000: 'd'}
...
def print_summary(best_P, all_results):
    ...
    print("\nKey Observations:")
    print("-" * 40)
    print("• Smaller datasets (N=100) require fewer hidden neurons (P~5-7)")
    print("• Larger datasets (N=10000) can utilize more neurons (P~30-40)")
